...
export const OptionItemBase = (props) => (
	<ListBoxItem
		...
		className='es:group es:any-focus:outline-hidden'
	>
		{props.extraPre}

		<div
			className={clsx(
				'es:flex es:min-h-9 es:select-none es:items-center es:gap-1 es:rounded-xl es:px-2 es:py-0.5 es:transition',
				'es:group-any-focus:outline-hidden',
