...
const controlStyles = {
	base: 'es-uic-border es-uic-rounded-md es-uic-bg-white es-uic-text-sm es-uic-transition es-uic-group es-uic-shadow !es-uic-min-h-10',
...
const selectInputStyles = ''; // 'es-uic-outline-4 es-uic-outline-green-800';
...
const menuStyles = 'es-uic-rounded-md es-uic-border es-uic-border-gray-200 es-uic-bg-white es-uic-shadow-lg es-uic-mt-1.5 es-uic-text-sm es-uic-overflow-x-hidden';
const optionStyles = {
	base: 'es-uic-p-2 !es-uic-flex es-uic-items-center es-uic-gap-1.5 es-uic-text-gray-800 es-uic-rounded [&>svg]:es-uic-size-5 [&>svg]:es-uic-text-gray-500 es-uic-transition es-uic-mx-1 first:es-uic-mt-1 last:es-uic-mb-1 !es-uic-w-auto',
