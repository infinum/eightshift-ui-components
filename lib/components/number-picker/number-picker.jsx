			...
			>
				<div className='es:flex es:gap-1'>
					<Group className={inputClass({ disabled, flat, size, readOnly })}>
						...
						<Input
							className='es:font-variation-["wdth"_84,"YTLC"_520,"wght"_325,"slnt"_0,"YTFI"_788] es:placeholder-shown:font-variation-["wdth"_100,"YTLC"_500,"wght"_250,"slnt"_-8] es:any-focus:outline-hidden! es:p-px es:border-none! es:shadow-none! es:bg-transparent'
